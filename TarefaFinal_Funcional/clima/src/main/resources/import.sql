...
insert into clima (id, semana_id, cidade_id, data_hora, temp_min, temp_max, umidade, descricao, icon_name) values (3, 3, 1, now(), 30, 45, 98, 'previsao terça', '01d');
 ...
 insert into cidade (id, nome, latitude, longitude) values (2,'Rio de Janeiro', 78.0, -45.0);
...
insert into cidade (id, nome, latitude, longitude) values (3,'São Mateus', 15.0, -57.0);
...
insert into cidade (id, nome, latitude, longitude) values (4,'Rio Grande Do Norte', 38.0, -17.0);
